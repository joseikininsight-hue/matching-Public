# 📱 D1 データベースセットアップ（3分で完了）

## 🎯 やること

D1 データベースにテーブルを作成します。

---

## ステップ 1: D1 Console を開く

1. https://dash.cloudflare.com/ を開く
2. 左メニューの **Workers & Pages** をタップ
3. **D1** をタップ
4. `助成金-db` データベースをタップ
5. **Console** タブをタップ
...
1. D1 Console の入力欄に **貼り付け**
2. **Execute** または **実行** ボタンをタップ
3. 成功メッセージが表示されるまで待つ
...
→ SQL を全部コピーできていません。最初から最後まで全てコピーしてください。
